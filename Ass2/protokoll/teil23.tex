...
Für ein größeres $\mu$ konvertiert der MSE wesentlich schneller gegen sein Minimum, allerdings ist auch
...
abhängt. Somit Konvergiert dieser Algorithmus bei einer großeren Varianz von $\vm{x}[n]$ schneller, bzw. bei einer
...
Da das Eingangssignal jetzt keine Weißes Rauschen mehr ist, sind die Eigenwerte von $\vm{R}_{xx}$ nicht mehr gleich.
